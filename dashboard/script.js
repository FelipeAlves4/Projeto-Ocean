...
const SUPPORTED_LANGUAGES = ['pt-BR', 'en-US', 'es-ES', 'fr-FR', 'de-DE']
...
const translations = {
    'pt-BR': {
        ...
        'summary.goals.inProgress': 'em progresso',
        'summary.goals.delayedSingular': 'atrasada',
        'summary.goals.delayedPlural': 'atrasadas',
    ...
    'en-US': {
        ...
        'summary.goals.delayedSingular': 'delayed',
        'summary.goals.delayedPlural': 'delayed',
    ...
    'es-ES': {
        ...
        'aria.mobileMenu': 'Menú',
        'aria.chatButton': 'Abrir chat de soporte',
        'aria.chatMinimize': 'Minimizar chat',
        'aria.chatSend': 'Enviar mensaje',
        'buttons.today': 'Hoy',
        'buttons.add': 'Agregar',
        'buttons.newTask': 'Nueva Tarea',
        'buttons.newGoal': 'Nueva Meta',
        'buttons.newTransaction': 'Nueva Transacción',
        'buttons.generateReport': 'Generar Informe',
        'buttons.newProduct': 'Nuevo Producto',
        'buttons.sendMessage': 'Enviar Mensaje',
        'buttons.manual': 'Manual del Usuario (PDF)',
        'buttons.logout': 'Cerrar Sesión',
        'buttons.clearData': 'Limpiar',
        'buttons.exportData': 'Exportar',
        'buttons.upgrade': 'Mejorar Plan',
        'buttons.upgradePremium': 'Mejorar a Premium',
        ...
        'sections.dashboard.title': 'Panel',
        'sections.dashboard.subtitle': 'Controla tus tareas, metas y finanzas en un solo lugar.',
        'sections.tarefas.title': 'Tareas',
        'sections.tarefas.subtitle': 'Gestiona todas tus tareas y proyectos.',
        'sections.metas.title': 'Metas',
        'sections.metas.subtitle': 'Sigue el progreso de tus metas.',
        'sections.financas.title': 'Finanzas',
        'sections.financas.subtitle': 'Controla tus ingresos y gastos.',
        'sections.produtos.title': 'Productos',
        'sections.produtos.subtitle': 'Gestiona tu catálogo de productos.',
        'sections.configuracoes.title': 'Configuración',
        'sections.configuracoes.subtitle': 'Personaliza tu experiencia.',
        'sections.perfil.title': 'Perfil',
        'sections.perfil.subtitle': 'Administra tu información personal.',
        'sections.ajuda.title': 'Ayuda',
        'sections.ajuda.subtitle': 'Encuentra respuestas a tus dudas.',
        'summary.tasks.title': 'Tareas Completadas',
        'summary.tasks.subtitle': '+2 completadas desde ayer',
        'summary.productiveTime.title': 'Tiempo Productivo',
        'summary.productiveTime.subtitle': '+1,2 h respecto al promedio',
        'summary.goals.title': 'Metas Activas',
        'summary.goals.subtitle': '3 en progreso, 1 retrasada',
        'summary.goals.inProgress': 'en progreso',
        'summary.goals.delayedSingular': 'retrasada',
        'summary.goals.delayedPlural': 'retrasadas',
        'summary.financial.title': 'Balance Financiero',
        'summary.financial.subtitle': '+12% respecto al mes pasado',
        'tabs.tasks': 'Tareas Recientes',
        'tabs.progress': 'Progreso de Metas',
        'tabs.financial': 'Visión Financiera',
        'tabs.products': 'Productos',
        'tabs.tarefas.title': 'Tareas Recientes',
        'tabs.tarefas.subtitle': 'Visualiza y gestiona tus tareas pendientes y completadas',
        'tabs.progresso.title': 'Progreso de Metas',
        'tabs.progresso.subtitle': 'Sigue el desarrollo de tus metas activas',
        'tabs.financeira.title': 'Visión Financiera',
        'tabs.financeira.subtitle': 'Revisa tus ingresos, gastos e inversiones',
        'tabs.produtos.title': 'Productos',
        'tabs.produtos.subtitle': 'Mira tus productos más recientes',
        'goals.description.productivity': 'Completar 20 tareas por semana',
        'goals.description.savings': 'Ahorrar R$ 1.000 este mes',
        'goals.description.learning': 'Estudiar 10 horas por semana',
        'tasks.badges.pending': 'Pendiente',
        'tasks.badges.completed': 'Completada',
        'filters.tasks.all': 'Todas',
        'filters.tasks.pending': 'Pendientes',
        'filters.tasks.completed': 'Completadas',
        'finances.buttons.newTransaction': 'Nueva Transacción',
        'finances.buttons.generateReport': 'Generar Informe',
        'finances.labels.receitas': 'Ingresos',
        'finances.labels.despesas': 'Gastos',
        'finances.labels.saldo': 'Saldo',
        'finances.transactions.title': 'Transacciones Recientes',
        'filters.transactions.all': 'Todas',
        'filters.transactions.income': 'Ingresos',
        'filters.transactions.expense': 'Gastos',
        'products.header.title': 'Gestiona tu catálogo de productos',
        'products.buttons.new': 'Nuevo Producto',
        'filters.products.categories.all': 'Todas las categorías',
        'filters.products.categories.eletronicos': 'Electrónicos',
        'filters.products.categories.roupas': 'Ropa',
        'filters.products.categories.alimentos': 'Alimentos',
        'filters.products.categories.casa': 'Hogar',
        'filters.products.categories.esportes': 'Deportes',
        'filters.products.categories.outros': 'Otros',
        'filters.products.status.all': 'Todos los estados',
        'filters.products.status.ativo': 'Activo',
        'filters.products.status.inativo': 'Inactivo',
        'filters.products.status.esgotado': 'Agotado',
        'placeholders.products.search': 'Buscar productos...',
        ...
        'settings.goalsNotifications.title': 'Notificaciones de Metas',
        'settings.goalsNotifications.description': 'Recibir actualizaciones sobre el progreso de las metas',
        'settings.account.title': 'Cuenta',
        'settings.logout.description': 'Salir de tu cuenta y volver al inicio de sesión',
        'settings.data.title': 'Datos',
        'settings.clearData.title': 'Limpiar Datos',
        'settings.clearData.description': 'Eliminar todos los datos guardados localmente',
        'settings.exportData.title': 'Exportar Datos',
        'settings.exportData.description': 'Descargar tus datos en formato JSON',
        'profile.stats.tasks': 'Tareas Completadas',
        'profile.stats.goals': 'Metas Activas',
        'profile.stats.days': 'Días de Uso',
        'profile.plan.basicTitle': 'Plan Básico',
        'profile.plan.basicSubtitle': 'Accede a funciones limitadas',
        'profile.plan.premiumTitle': 'Plan Premium',
        'profile.plan.premiumSubtitle': 'Acceso completo a todas las funciones',
        'profile.plan.features.basicReports': 'Informes básicos',
        'profile.plan.features.basicCharts': 'Gráficos esenciales',
        'profile.plan.features.basicExport': 'Exportación básica',
        'profile.plan.features.premiumReports': 'Informes completos y avanzados',
        'profile.plan.features.premiumTrends': 'Análisis de tendencias y proyecciones',
        'profile.plan.features.premiumRecommendations': 'Recomendaciones personalizadas',
        'profile.plan.features.premiumExport': 'Exportación de alta calidad',
        'profile.form.title': 'Información Personal',
        'form.labels.name': 'Nombre',
        'form.labels.email': 'Correo',
        'form.labels.bio': 'Bio',
        'placeholders.profile.name': 'Tu nombre',
        'placeholders.profile.bio': 'Cuenta un poco sobre ti...',
        'placeholders.profile.email': 'tu@email.com',
        'help.search.placeholder': 'Buscar ayuda...',
        'help.faq.title': 'Preguntas Frecuentes',
        'faq.q1.question': '¿Cómo agregar una nueva tarea?',
        'faq.q1.answer': 'Para agregar una nueva tarea, haz clic en el botón "Agregar" en la parte superior o usa el atajo Ctrl+K. También puedes ir a la sección Tareas y hacer clic en "Nueva Tarea".',
        'faq.q2.question': '¿Cómo seguir el progreso de mis metas?',
        'faq.q2.answer': 'Entra en la sección "Metas" del menú lateral. Allí podrás ver todas tus metas, actualizar el progreso y acompañar el porcentaje de avance.',
        'faq.q3.question': '¿Cómo gestionar mis finanzas?',
        'faq.q3.answer': 'En la sección "Finanzas" puedes agregar ingresos y gastos, ver tu saldo total y revisar transacciones recientes. Usa "Nueva Transacción" para registrar movimientos.',
        'faq.q4.question': '¿Cómo exporto mis datos?',
        'faq.q4.answer': 'Ve a "Configuración" y desplázate hasta "Datos". Haz clic en "Exportar Datos" para descargar un archivo JSON con toda tu información.',
        'faq.q5.question': '¿Mis datos están seguros?',
        'faq.q5.answer': '¡Sí! Todos tus datos se guardan localmente en tu navegador mediante localStorage. No se envía nada a servidores externos.',
        'help.contact.title': '¿Necesitas más ayuda?',
        'help.contact.text': 'Comunícate con nosotros al correo: suporte@ocean.com',
        'buttons.help.manual': 'Manual del Usuario (PDF)',
        'modal.report.title': 'Informe Financiero',
        'chat.title': 'Soporte Ocean',
        'chat.status': 'En línea ahora',
        'chat.initialMessage': '¡Hola! 👋 Bienvenido al soporte de Ocean. ¿Cómo puedo ayudarte hoy?',
        'chat.message.now': 'Ahora',
        'chat.suggestion.addTask': '¿Cómo agregar una tarea?',
        'chat.suggestion.manageFinance': '¿Cómo gestionar finanzas?',
        'chat.suggestion.productHelp': 'Ayuda con productos',
        'placeholders.chat.input': 'Escribe tu mensaje...'
    },
    'fr-FR': {
        'aria.languageSelect': 'Choisir la langue',
        'aria.mobileMenu': 'Menu',
        'aria.chatButton': 'Ouvrir le chat de support',
        'aria.chatMinimize': 'Réduire le chat',
        'aria.chatSend': 'Envoyer le message',
        'buttons.today': 'Aujourd\'hui',
        'buttons.add': 'Ajouter',
        'buttons.newTask': 'Nouvelle Tâche',
        'buttons.newGoal': 'Nouvel Objectif',
        'buttons.newTransaction': 'Nouvelle Transaction',
        'buttons.generateReport': 'Générer un rapport',
        'buttons.newProduct': 'Nouveau Produit',
        'buttons.sendMessage': 'Envoyer un message',
        'buttons.manual': 'Manuel de l\'utilisateur (PDF)',
        'buttons.logout': 'Se déconnecter',
        'buttons.clearData': 'Effacer',
        'buttons.exportData': 'Exporter',
        'buttons.upgrade': 'Mettre à niveau',
        'buttons.upgradePremium': 'Passer au Premium',
        'buttons.saveChanges': 'Enregistrer les modifications',
        'buttons.exportPdf': 'Exporter en PDF',
        ...
        'sections.dashboard.title': 'Tableau de bord',
        'sections.dashboard.subtitle': 'Gérez vos tâches, objectifs et finances en un seul endroit.',
        'sections.tarefas.title': 'Tâches',
        'sections.tarefas.subtitle': 'Gérez toutes vos tâches et projets.',
        'sections.metas.title': 'Objectifs',
        'sections.metas.subtitle': 'Suivez la progression de vos objectifs.',
        'sections.financas.title': 'Finances',
        'sections.financas.subtitle': 'Contrôlez vos revenus et dépenses.',
        'sections.produtos.title': 'Produits',
        'sections.produtos.subtitle': 'Gérez votre catalogue de produits.',
        'sections.configuracoes.title': 'Paramètres',
        'sections.configuracoes.subtitle': 'Personnalisez votre expérience.',
        'sections.perfil.title': 'Profil',
        'sections.perfil.subtitle': 'Gérez vos informations personnelles.',
        'sections.ajuda.title': 'Aide',
        'sections.ajuda.subtitle': 'Trouvez des réponses à vos questions.',
        'summary.tasks.title': 'Tâches terminées',
        'summary.tasks.subtitle': '+2 terminées depuis hier',
        'summary.productiveTime.title': 'Temps productif',
        'summary.productiveTime.subtitle': '+1,2 h par rapport à la moyenne',
        'summary.goals.title': 'Objectifs actifs',
        'summary.goals.subtitle': '3 en cours, 1 en retard',
        'summary.goals.inProgress': 'en cours',
        'summary.goals.delayedSingular': 'en retard',
        'summary.goals.delayedPlural': 'en retard',
        'summary.financial.title': 'Balance financière',
        'summary.financial.subtitle': '+12 % par rapport au mois dernier',
        'tabs.tasks': 'Tâches récentes',
        'tabs.progress': 'Progression des objectifs',
        'tabs.financial': 'Vue financière',
        'tabs.products': 'Produits',
        'tabs.tarefas.title': 'Tâches récentes',
        'tabs.tarefas.subtitle': 'Visualisez et gérez vos tâches en attente ou terminées',
        'tabs.progresso.title': 'Progression des objectifs',
        'tabs.progresso.subtitle': 'Suivez l’évolution de vos objectifs actifs',
        'tabs.financeira.title': 'Vue financière',
        'tabs.financeira.subtitle': 'Suivez vos revenus, dépenses et investissements',
        'tabs.produtos.title': 'Produits',
        'tabs.produtos.subtitle': 'Découvrez vos produits les plus récents',
        'goals.description.productivity': 'Terminer 20 tâches par semaine',
        'goals.description.savings': 'Économiser 1 000 R$ ce mois-ci',
        'goals.description.learning': 'Étudier 10 heures par semaine',
        'tasks.badges.pending': 'En attente',
        'tasks.badges.completed': 'Terminée',
        'filters.tasks.all': 'Toutes',
        'filters.tasks.pending': 'En attente',
        'filters.tasks.completed': 'Terminées',
        'finances.buttons.newTransaction': 'Nouvelle Transaction',
        'finances.buttons.generateReport': 'Générer un rapport',
        'finances.labels.receitas': 'Revenus',
        'finances.labels.despesas': 'Dépenses',
        'finances.labels.saldo': 'Solde',
        'finances.transactions.title': 'Transactions récentes',
        'filters.transactions.all': 'Toutes',
        'filters.transactions.income': 'Revenus',
        'filters.transactions.expense': 'Dépenses',
        'products.header.title': 'Gérez votre catalogue de produits',
        'products.buttons.new': 'Nouveau Produit',
        'filters.products.categories.all': 'Toutes les catégories',
        'filters.products.categories.eletronicos': 'Électroniques',
        'filters.products.categories.roupas': 'Vêtements',
        'filters.products.categories.alimentos': 'Aliments',
        'filters.products.categories.casa': 'Maison',
        'filters.products.categories.esportes': 'Sports',
        'filters.products.categories.outros': 'Autres',
        'filters.products.status.all': 'Tous les statuts',
        'filters.products.status.ativo': 'Actif',
        'filters.products.status.inativo': 'Inactif',
        'filters.products.status.esgotado': 'Épuisé',
        'placeholders.products.search': 'Rechercher des produits...',
        ...
        'settings.goalsNotifications.title': 'Notifications d\'objectifs',
        'settings.goalsNotifications.description': 'Recevoir des mises à jour sur la progression des objectifs',
        'settings.account.title': 'Compte',
        'settings.logout.description': 'Se déconnecter et revenir à la page de connexion',
        'settings.data.title': 'Données',
        'settings.clearData.title': 'Effacer les données',
        'settings.clearData.description': 'Supprimer toutes les données enregistrées localement',
        'settings.exportData.title': 'Exporter les données',
        'settings.exportData.description': 'Télécharger vos données au format JSON',
        'profile.stats.tasks': 'Tâches terminées',
        'profile.stats.goals': 'Objectifs actifs',
        'profile.stats.days': 'Jours d\'utilisation',
        'profile.plan.basicTitle': 'Plan Basique',
        'profile.plan.basicSubtitle': 'Accédez à des fonctionnalités limitées',
        'profile.plan.premiumTitle': 'Plan Premium',
        'profile.plan.premiumSubtitle': 'Accès complet à toutes les fonctionnalités',
        'profile.plan.features.basicReports': 'Rapports basiques',
        'profile.plan.features.basicCharts': 'Graphiques essentiels',
        'profile.plan.features.basicExport': 'Exportation basique',
        'profile.plan.features.premiumReports': 'Rapports complets et avancés',
        'profile.plan.features.premiumTrends': 'Analyse des tendances et prévisions',
        'profile.plan.features.premiumRecommendations': 'Recommandations personnalisées',
        'profile.plan.features.premiumExport': 'Exportation de haute qualité',
        'profile.form.title': 'Informations personnelles',
        'form.labels.name': 'Nom',
        'form.labels.email': 'Email',
        'form.labels.bio': 'Bio',
        'placeholders.profile.name': 'Votre nom',
        'placeholders.profile.bio': 'Parlez un peu de vous...',
        'placeholders.profile.email': 'votre@email.com',
        'help.search.placeholder': 'Rechercher de l\'aide...',
        'help.faq.title': 'Foire aux questions',
        'faq.q1.question': 'Comment ajouter une nouvelle tâche ?',
        'faq.q1.answer': 'Pour ajouter une nouvelle tâche, cliquez sur "Ajouter" en haut de la page ou utilisez le raccourci Ctrl+K. Vous pouvez aussi ouvrir la section Tâches et cliquer sur "Nouvelle Tâche".',
        'faq.q2.question': 'Comment suivre la progression de mes objectifs ?',
        'faq.q2.answer': 'Accédez à la section "Objectifs" dans le menu latéral. Vous pourrez y voir tous vos objectifs, mettre à jour leur progression et suivre le pourcentage d’avancement.',
        'faq.q3.question': 'Comment gérer mes finances ?',
        'faq.q3.answer': 'Dans la section "Finances", vous pouvez ajouter des revenus et dépenses, voir votre solde total et consulter les transactions récentes. Utilisez "Nouvelle Transaction" pour enregistrer un mouvement.',
        'faq.q4.question': 'Comment exporter mes données ?',
        'faq.q4.answer': 'Allez dans "Paramètres" puis dans la section "Données". Cliquez sur "Exporter les données" pour télécharger un fichier JSON contenant toutes vos informations.',
        'faq.q5.question': 'Mes données sont-elles en sécurité ?',
        'faq.q5.answer': 'Oui ! Toutes vos données sont stockées localement dans votre navigateur via localStorage. Aucune information n’est envoyée à des serveurs externes.',
        'help.contact.title': 'Besoin de plus d\'aide ?',
        'help.contact.text': 'Contactez-nous par email : suporte@ocean.com',
        'buttons.help.manual': 'Manuel de l\'utilisateur (PDF)',
        'modal.report.title': 'Rapport financier',
        'chat.title': 'Support Ocean',
        'chat.status': 'En ligne maintenant',
        'chat.initialMessage': 'Bonjour ! 👋 Bienvenue sur le support Ocean. Comment puis-je vous aider aujourd\'hui ?',
        'chat.message.now': 'Maintenant',
        'chat.suggestion.addTask': 'Comment ajouter une tâche ?',
        'chat.suggestion.manageFinance': 'Comment gérer les finances ?',
        'chat.suggestion.productHelp': 'Aide sur les produits',
        'placeholders.chat.input': 'Tapez votre message...'
    },
    'de-DE': {
        'aria.languageSelect': 'Sprache auswählen',
        'aria.mobileMenu': 'Menü',
        'aria.chatButton': 'Support-Chat öffnen',
        'aria.chatMinimize': 'Chat minimieren',
        'aria.chatSend': 'Nachricht senden',
        'buttons.today': 'Heute',
        'buttons.add': 'Hinzufügen',
        'buttons.newTask': 'Neue Aufgabe',
        'buttons.newGoal': 'Neues Ziel',
        'buttons.newTransaction': 'Neue Transaktion',
        'buttons.generateReport': 'Bericht erstellen',
        'buttons.newProduct': 'Neues Produkt',
        'buttons.sendMessage': 'Nachricht senden',
        'buttons.manual': 'Benutzerhandbuch (PDF)',
        'buttons.logout': 'Abmelden',
        'buttons.clearData': 'Löschen',
        'buttons.exportData': 'Exportieren',
        'buttons.upgrade': 'Upgrade',
        'buttons.upgradePremium': 'Auf Premium upgraden',
        'buttons.saveChanges': 'Änderungen speichern',
        'buttons.exportPdf': 'PDF exportieren',
        'nav.dashboard': 'Dashboard',
        'nav.tarefas': 'Aufgaben',
        'nav.metas': 'Ziele',
        ...
        'sections.dashboard.title': 'Dashboard',
        'sections.dashboard.subtitle': 'Verwalte Aufgaben, Ziele und Finanzen an einem Ort.',
        'sections.tarefas.title': 'Aufgaben',
        'sections.tarefas.subtitle': 'Verwalte all deine Aufgaben und Projekte.',
        'sections.metas.title': 'Ziele',
        'sections.metas.subtitle': 'Verfolge den Fortschritt deiner Ziele.',
        'sections.financas.title': 'Finanzen',
        'sections.financas.subtitle': 'Behalte Einnahmen und Ausgaben im Blick.',
        'sections.produtos.title': 'Produkte',
        'sections.produtos.subtitle': 'Verwalte deinen Produktkatalog.',
        'sections.configuracoes.title': 'Einstellungen',
        'sections.configuracoes.subtitle': 'Passe dein Erlebnis an.',
        'sections.perfil.title': 'Profil',
        'sections.perfil.subtitle': 'Verwalte deine persönlichen Informationen.',
        'sections.ajuda.title': 'Hilfe',
        'sections.ajuda.subtitle': 'Finde Antworten auf deine Fragen.',
        'summary.tasks.title': 'Erledigte Aufgaben',
        'summary.tasks.subtitle': '+2 seit gestern',
        'summary.productiveTime.title': 'Produktive Zeit',
        'summary.productiveTime.subtitle': '+1,2 h im Vergleich zum Durchschnitt',
        'summary.goals.title': 'Aktive Ziele',
        'summary.goals.subtitle': '3 in Bearbeitung, 1 verspätet',
        'summary.goals.inProgress': 'in Bearbeitung',
        'summary.goals.delayedSingular': 'verspätet',
        'summary.goals.delayedPlural': 'verspätet',
        'summary.financial.title': 'Finanzübersicht',
        'summary.financial.subtitle': '+12 % gegenüber dem Vormonat',
        'tabs.tasks': 'Aktuelle Aufgaben',
        'tabs.progress': 'Zielverlauf',
        'tabs.financial': 'Finanzüberblick',
        'tabs.products': 'Produkte',
        'tabs.tarefas.title': 'Aktuelle Aufgaben',
        'tabs.tarefas.subtitle': 'Sieh dir offene und erledigte Aufgaben an',
        'tabs.progresso.title': 'Zielverlauf',
        'tabs.progresso.subtitle': 'Verfolge die Entwicklung deiner aktiven Ziele',
        'tabs.financeira.title': 'Finanzüberblick',
        'tabs.financeira.subtitle': 'Verfolge Einnahmen, Ausgaben und Investitionen',
        'tabs.produtos.title': 'Produkte',
        'tabs.produtos.subtitle': 'Sieh deine neuesten Produkte',
        'goals.description.productivity': '20 Aufgaben pro Woche abschließen',
        'goals.description.savings': 'Diesen Monat 1.000 R$ sparen',
        'goals.description.learning': '10 Stunden pro Woche lernen',
        'tasks.badges.pending': 'Ausstehend',
        'tasks.badges.completed': 'Erledigt',
        'filters.tasks.all': 'Alle',
        'filters.tasks.pending': 'Ausstehend',
        'filters.tasks.completed': 'Erledigt',
        'finances.buttons.newTransaction': 'Neue Transaktion',
        'finances.buttons.generateReport': 'Bericht erstellen',
        'finances.labels.receitas': 'Einnahmen',
        'finances.labels.despesas': 'Ausgaben',
        'finances.labels.saldo': 'Saldo',
        'finances.transactions.title': 'Aktuelle Transaktionen',
        'filters.transactions.all': 'Alle',
        'filters.transactions.income': 'Einnahmen',
        'filters.transactions.expense': 'Ausgaben',
        'products.header.title': 'Verwalte deinen Produktkatalog',
        'products.buttons.new': 'Neues Produkt',
        'filters.products.categories.all': 'Alle Kategorien',
        'filters.products.categories.eletronicos': 'Elektronik',
        'filters.products.categories.roupas': 'Bekleidung',
        'filters.products.categories.alimentos': 'Lebensmittel',
        'filters.products.categories.casa': 'Haushalt',
        'filters.products.categories.esportes': 'Sport',
        'filters.products.categories.outros': 'Andere',
        'filters.products.status.all': 'Alle Status',
        'filters.products.status.ativo': 'Aktiv',
        'filters.products.status.inativo': 'Inaktiv',
        'filters.products.status.esgotado': 'Ausverkauft',
        'placeholders.products.search': 'Produkte suchen...',
        ...
        'settings.goalsNotifications.title': 'Zielbenachrichtigungen',
        'settings.goalsNotifications.description': 'Updates zum Zielverlauf erhalten',
        'settings.account.title': 'Konto',
        'settings.logout.description': 'Melde dich ab und kehre zur Login-Seite zurück',
        'settings.data.title': 'Daten',
        'settings.clearData.title': 'Daten löschen',
        'settings.clearData.description': 'Alle lokal gespeicherten Daten entfernen',
        'settings.exportData.title': 'Daten exportieren',
        'settings.exportData.description': 'Lade deine Daten als JSON herunter',
        'profile.stats.tasks': 'Erledigte Aufgaben',
        'profile.stats.goals': 'Aktive Ziele',
        'profile.stats.days': 'Nutzungstage',
        'profile.plan.basicTitle': 'Basistarif',
        'profile.plan.basicSubtitle': 'Zugang zu eingeschränkten Funktionen',
        'profile.plan.premiumTitle': 'Premium-Tarif',
        'profile.plan.premiumSubtitle': 'Voller Zugriff auf alle Funktionen',
        'profile.plan.features.basicReports': 'Einfache Berichte',
        'profile.plan.features.basicCharts': 'Wesentliche Diagramme',
        'profile.plan.features.basicExport': 'Basis-Export',
        'profile.plan.features.premiumReports': 'Umfassende, erweiterte Berichte',
        'profile.plan.features.premiumTrends': 'Trend- und Prognoseanalyse',
        'profile.plan.features.premiumRecommendations': 'Personalisierte Empfehlungen',
        'profile.plan.features.premiumExport': 'Export in hoher Qualität',
        'profile.form.title': 'Persönliche Informationen',
        'form.labels.name': 'Name',
        'form.labels.email': 'E-Mail',
        'form.labels.bio': 'Biografie',
        'placeholders.profile.name': 'Dein Name',
        'placeholders.profile.bio': 'Erzähle kurz etwas über dich...',
        'placeholders.profile.email': 'dein@email.com',
        'help.search.placeholder': 'Hilfe suchen...',
        'help.faq.title': 'Häufig gestellte Fragen',
        'faq.q1.question': 'Wie füge ich eine neue Aufgabe hinzu?',
        'faq.q1.answer': 'Klicke auf „Hinzufügen“ oben auf der Seite oder nutze das Kürzel Strg+K. Du kannst auch den Bereich Aufgaben öffnen und „Neue Aufgabe“ wählen.',
        'faq.q2.question': 'Wie verfolge ich meine Ziele?',
        'faq.q2.answer': 'Öffne im Menü den Bereich „Ziele“. Dort kannst du alle Ziele sehen, den Fortschritt aktualisieren und den Abschlussgrad verfolgen.',
        'faq.q3.question': 'Wie verwalte ich meine Finanzen?',
        'faq.q3.answer': 'Im Bereich „Finanzen“ kannst du Einnahmen und Ausgaben hinzufügen, deinen Gesamtsaldo einsehen und Transaktionen prüfen. Nutze „Neue Transaktion“, um Bewegungen zu erfassen.',
        'faq.q4.question': 'Wie exportiere ich meine Daten?',
        'faq.q4.answer': 'Gehe zu „Einstellungen“ und scrolle zu „Daten“. Klicke auf „Daten exportieren“, um eine JSON-Datei mit allen Informationen herunterzuladen.',
        'faq.q5.question': 'Sind meine Daten sicher?',
        'faq.q5.answer': 'Ja! Alle Daten werden lokal in deinem Browser über localStorage gespeichert. Es wird nichts an externe Server gesendet.',
        'help.contact.title': 'Brauchst du weitere Hilfe?',
        'help.contact.text': 'Schreib uns per E-Mail: suporte@ocean.com',
        'buttons.help.manual': 'Benutzerhandbuch (PDF)',
        'modal.report.title': 'Finanzbericht',
        'chat.title': 'Ocean Support',
        'chat.status': 'Jetzt online',
        'chat.initialMessage': 'Hallo! 👋 Willkommen beim Ocean Support. Wie kann ich dir heute helfen?',
        'chat.message.now': 'Jetzt',
        'chat.suggestion.addTask': 'Wie füge ich eine Aufgabe hinzu?',
        'chat.suggestion.manageFinance': 'Wie verwalte ich Finanzen?',
        'chat.suggestion.productHelp': 'Hilfe zu Produkten',
        'placeholders.chat.input': 'Schreib deine Nachricht...'
    }
}
...
function renderSummaryCards() {
    ...
    const inProgressLabel = t('summary.goals.inProgress')
    const delayedLabel = goalsDelayed === 1 ? t('summary.goals.delayedSingular') : t('summary.goals.delayedPlural')
    ...
    const balanceLocale = currencyLocaleMap[currentLanguage] || 'pt-BR'
    const balanceFormatter = new Intl.NumberFormat(balanceLocale, {
        style: 'currency',
        currency: 'BRL'
    })
